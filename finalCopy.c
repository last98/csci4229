...
static void table(double sx, double sy, double sz, double x, double y, double z, double dx, double dy, double dz, double th){
	glScaled(sx,sy,sz);
...
static void first(double s, double x, double y, double z){
	glScaled(s,s,s);
	glTranslated(x,y,z);
	...
	aloe(s*0.3, 1,0.5,0);
		...
		glColor3f(0.658, 0.643, 0.643);
			
		// table
		table(s,s,s,2,-1.5,0,1,1,1,0);
}
...
static void leafyPlant(double x, double y, double z, double sx, double sy, double sz){
	...
	pot(2,0,-4, 0.8, 0.6, 1.5);
	//double sx, double sy, double sz, double x, double y, double z, double dx, double dy, double dz, double th
	table(1.5, 1, 1.3, 2, 0, -3, 1,1,1,0);
	fullLeafyLeaf(2,0,-4, 0,0,0, 0,0.2,0.5,0.1);
